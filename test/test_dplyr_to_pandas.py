...
class TestDplyrToPandas:
    ...
    def test_count_pandasWeight(self) -> None:
        ...
        expected = pd.DataFrame({"gender": ["female", "male"], "n": [5, 10]})
        expected["gender"] = expected["gender"].astype("category")
    ...
    def test_distinct_pandasAll(self) -> None:
        data = pd.DataFrame(
            {
                "x": np.random.choice(10, 100, replace=True),
                "y": np.random.choice(10, 100, replace=True),
            }
        )
        ...
        expected = pd.DataFrame(
            {
                ...
                "height": [202.0, 178.0, 228.0, 175.0, 180.0],
                "mass": [136.0, 120.0, 112.0, 1358.0, 110.0],
                ...
                "birth_year": [41.9, 52.0, 200.0, 600.0, np.nan],
                "sex": ["male", "male", "male", "hermaphroditic", "male"],
                "gender": ["masculine"] * 5,
                "homeworld": [
                    "Tatooine",
                    "Tatooine",
        ...
        expected = pd.DataFrame(
            {
                ...
                "height": [202.0, 178.0, 183.0, 188.0, 228.0],
                "mass": [136.0, 120.0, 84.0, 84.0, 112.0],
                ...
                "birth_year": [41.9, 52.0, 24.0, 41.9, 200.0],
                "sex": ["male"] * 5,
                "gender": ["masculine"] * 5,
                "homeworld": [
                    "Tatooine",
    ...
    def test_mutate_pandasString_cummax(self) -> None:
        data = pd.DataFrame({"x": [3, 4, 2, 5, 1], "y": [10, 100, 1000, 10000, 100000]})
        expected = pd.DataFrame(
            {
                "x": [3, 4, 2, 5, 1],
                "y": [10, 100, 1000, 10000, 100000],
